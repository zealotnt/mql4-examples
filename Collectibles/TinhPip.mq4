...
extern color color1=clrLimeGreen;
extern color color2=clrBlack;
...
int init() {
   ...
   ObjectSet("lpm_pips",OBJPROP_YDISTANCE,100);
   ...
   ObjectSet("lpm_pips_tosl",OBJPROP_XDISTANCE,-100);
   ...
   ObjectSet("lpm_pips_realized",OBJPROP_XDISTANCE,30);
   ObjectSet("lpm_pips_realized",OBJPROP_YDISTANCE,85); 
   ...
   ObjectSet("lpm_longlabel",OBJPROP_XDISTANCE,-100);
   ...
   ObjectSet("lpm_shortlabel",OBJPROP_XDISTANCE,-100);
   ...
   ObjectSet("lpm_long",OBJPROP_XDISTANCE,-65);
   ObjectSet("lpm_long",OBJPROP_YDISTANCE,90);
   ...
   ObjectSet("lpm_short",OBJPROP_XDISTANCE,-65);
   ObjectSet("lpm_short",OBJPROP_YDISTANCE,70);
